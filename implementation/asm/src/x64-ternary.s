# ============================================================
# Tagged-ternary node representation (the original x64 layout).
# `x64` itself now uses the tagless two-word layout; this variant
# preserves the explicit [tag][children] nodes for comparison.
#

# ============================================================
# Rosetta-compatible twin of x64 (identical code; kept as the variant
# that guarantees loadability under Apple's Rosetta — the other variants
# are free to exploit header fields Rosetta validates but Linux ignores).
#
